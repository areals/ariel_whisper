...
processing_message = st.empty() # added this line

if st.button("Empezar"):
    if uploaded_audio:
        if api_key:
            processing_message.text("Transcribiendo el audio...") # changed from st.markdown to processing_message.text
            ...
            processing_message.text("Procesando la transcripción...") # changed from st.markdown to processing_message.text
            if custom_prompt:
            ...
            processing_message.empty() # added this line
        else:
